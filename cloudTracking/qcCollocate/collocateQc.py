...
if __name__ == "__main__":
    ...
    for tIdx in timeIdxArange:
        ...
        if len(lwpTrackIDCandicate) >= 1:
            ...
            for qcIdx in qcObjectCandicate:
                ...
                if len(correspondLWP) == 0: 
                    ...
                    continue
                collocateQc[qcObject == qcIdx] = correspondLWP[area == np.max(area)][0]
        ...
        xrCollocateQcObject = xr.DataArray(collocateQc.astype(int), 
